...
tmux pipe-pane -t "$TMUX_SESSION" -o "sed -e 's/\x1b\[[0-9;]*m//g' -e 's/\x1b\[[0-9;]*[A-Za-z]//g' -e 's/\x1b\[[0-9]*[JK]//g' -e 's/\[?2004[lh]//g' >> logs/claude_terminal.log"
echo "✅ Логирование настроено: logs/claude_terminal.log"
